...
public interface UserService {
     ...
     * @return UserListResponse user List
     */
    UserListResponse findApproveUser(int userId, String superuser, int pageNo, int limit, String name, List<Integer> groups);
     ...
     */
    List<UserGroupTree> getGroupTree(int userId, List<Integer> currentGroup, String superuser, int type, int groupId, int roleId);
     ...
     * @return update message
     */
    UserPieResponse getUserDistributionData();
